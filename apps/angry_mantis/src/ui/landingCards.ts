...
// NOTE: no guaranteed-floor (400×) figure here by explicit decision.
...
export const LANDING_CARDS: LandingCard[] = [
	{
		...
		body: 'Marty and Marky run the meanest cafeteria in Block B, and the menu is eight kinds of bug. Land Markys to open the free games, where every course eaten makes the rest hit harder, all the way up to a 20,000× max win.',
